...
public class TrackedBeaconsFragment$$ViewBinder<T extends com.ateam.funshoppers.ui.fragment.TrackedBeaconsFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131755179, "field 'mListBeacons'");
    target.mListBeacons = finder.castView(view, 2131755179, "field 'mListBeacons'");
    ...
    view = finder.findRequiredView(source, 2131755180, "field 'mEmpty'");
    target.mEmpty = finder.castView(view, 2131755180, "field 'mEmpty'");
