...
public class ScanRadarFragment$$ViewBinder<T extends com.ateam.funshoppers.ui.fragment.ScanRadarFragment> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    ...
    view = finder.findRequiredView(source, 2131755203, "field 'mRadar'");
    target.mRadar = finder.castView(view, 2131755203, "field 'mRadar'");
    view = finder.findRequiredView(source, 2131755204, "field 'mDistView'");
    target.mDistView = finder.castView(view, 2131755204, "field 'mDistView'");
  }
