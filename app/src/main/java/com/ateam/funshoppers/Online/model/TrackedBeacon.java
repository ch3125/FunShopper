...
public class TrackedBeacon implements IManagedBeacon, com.ateam.funshoppers.model.ITriggerable, Parcelable {
    ...
    private List<com.ateam.funshoppers.model.ActionBeacon> actions = new ArrayList<>();
    ...
    @Override
    public void addAction(com.ateam.funshoppers.model.ActionBeacon action) {
    ...
    @Override
    public List<com.ateam.funshoppers.model.ActionBeacon> getActions() {
        return actions;
    }
